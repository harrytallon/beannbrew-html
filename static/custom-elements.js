    ...
    constructor() {
        ...
        <nav class="btmNav">
            <div class="spaceMeEvenly">
                <button href="/"><img src="assets/home.svg" alt="home button"></img></button>
                <button><img src="/static/assets/food-menu.svg" alt="food menu button"></img></button>
                <button><img src="/static/assets/notification.svg"></img></button>
                <button><img src="/assets/profile.svg"></img></button>
            </div>
        </nav>
        `;
        shadow.appendChild(wrapper);
